package com.denisenko.supplierservice.controller.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleOrderAlreadySentException(OrderAlreadySentException exception) {
        return new ResponseEntity<>(exception.getMessage(), HttpStatus.BAD_REQUEST);
    }
